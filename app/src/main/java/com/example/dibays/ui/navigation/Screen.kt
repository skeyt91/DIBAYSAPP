...
sealed class Screen(val route: String, val title: String) {
    ...
    data object Orders : Screen("pedidos", "Pedidos")
    data object Inventory : Screen("inventario", "Inventario")
    data object Sales : Screen("ventas", "Ventas")
    data object Assistant : Screen("asistente_inteligente", "Asistente Inteligente")
    data object OnlineCatalog : Screen("catalogo_online", "Catalogo Online")
    data object Finances : Screen("finanzas", "Finanzas")
    data object Coupon : Screen("cupon", "Cupon")
    ...
    data object Settings : Screen("configuraciones", "Configuraciones")
    data object Help : Screen("ayuda", "Ayuda")
    data object Transactions : Screen("transacciones", "Transacciones")
